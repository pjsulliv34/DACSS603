...
urlfile <- "https://raw.githubusercontent.com/avehtari/ROS-Examples/master/Earnings/data/wfw90.dat"

data1 <- read_table(urlfile, na = c("",NA))

sapply(data1, function(Count) sum(is.na(Count)))
